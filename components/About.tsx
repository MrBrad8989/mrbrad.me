...
export default function About() {
  ...
  const socials = [
    ...
    { name: "Email", icon: Mail, href: "mailto:tu-correo@ejemplo.com", color: "hover:bg-blue-50 dark:hover:bg-blue-600/20 hover:text-blue-600 dark:hover:text-blue-400 hover:border-blue-500/50" },
  ];
    ...
    <section id="sobre-mi" className="w-full max-w-6xl py-24 px-6 mx-auto mb-20">
      ...
      >
        <h2 className="text-3xl font-bold md:text-5xl flex items-center gap-4 text-zinc-900 dark:text-white">
          <Terminal className="h-8 w-8 text-blue-600 dark:text-blue-500" />
          <span>Player <span className="text-transparent bg-clip-text bg-linear-to-r from-blue-500 to-cyan-200 dark:from-blue-400 dark:to-cyan-200">Profile</span></span>
        </h2>
      </motion.div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        >
          <div className="relative group shrink-0">
            <div className="absolute -inset-1 bg-linear-to-r from-blue-500 to-purple-500 rounded-2xl blur-sm opacity-20 group-hover:opacity-50 transition duration-500"></div>
            <div className="relative h-40 w-40 sm:h-48 sm:w-48 rounded-2xl overflow-hidden border-2 border-white dark:border-zinc-800 group-hover:border-blue-500/50 transition-colors bg-zinc-100 dark:bg-zinc-950">
              <img 
          ...
          <div className="flex-1 text-center sm:text-left">
            <h3 className="text-2xl font-bold text-zinc-900 dark:text-zinc-100 mb-2 flex items-center justify-center sm:justify-start gap-2">
              <UserCircle className="text-blue-600 dark:text-blue-400 h-6 w-6" /> MrBrad
            </h3>
            <div className="space-y-4 text-zinc-600 dark:text-zinc-400 leading-relaxed text-sm sm:text-base">
              <p>
                ¡Hola! Soy un <b>Desarrollador Full-Stack</b> apasionado por crear experiencias web que no solo funcionen a la perfección por detrás, sino que se vean increíbles por delante.
              </p>
              <p>
        ...
        >
          <h3 className="text-xl font-bold text-zinc-900 dark:text-zinc-100 mb-6 font-mono text-sm uppercase tracking-wider flex items-center gap-2">
            <span className="text-blue-600 dark:text-blue-500">{">"}</span> Social_Links
          </h3>
        ...
        >
          <h3 className="text-xl font-bold text-zinc-900 dark:text-zinc-100 mb-6 font-mono text-sm uppercase tracking-wider flex items-center gap-2">
            <span className="text-blue-600 dark:text-blue-500">{">"}</span> Skills_Tree
          </h3>
