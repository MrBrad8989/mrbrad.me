...
export default function Home() {
  return (
    <main className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-zinc-950 text-white">
      
      {/* Patrón de cuadrícula de fondo actualizado a Tailwind v4 */}
      ...
      >
        {/* Etiqueta estilo consola con las comillas corregidas (&quot;) */}
        ...
        {/* Botón estilo Gamer/Tech */}
        <motion.button 
          whileHover={{ scale: 1.05 }}
          whileTap={{ scale: 0.95 }}
          className="mt-8 rounded-md bg-white px-8 py-3 font-semibold text-zinc-950 transition-colors hover:bg-zinc-200"
        >
          START GAME
        </motion.button>
      </motion.div>
